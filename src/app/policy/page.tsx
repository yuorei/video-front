  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-4">
          <li className="mb-2">荒らし行為、嫌がらせ、いたずら、人を傷つける行為は禁止されています。</li>
          <li className="mb-2">コミュニティメンバーに対する尊重と礼儀を守りましょう。</li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-4">
          ...
          <p>他人の著作権を尊重し、他人のコンテンツを無断でアップロードしないでください。</p>
          <li className="mb-2">自分のコンテンツ</li>
          <p>コンテンツ作成者は、自分のコンテンツに対する所有権を維持し、共有することができます。</p>
        </ul>
      </section>

      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4">コミュニティとフィードバック</h2>
        <ul className="list-disc pl-4">
          <li className="mb-2">ポジティブなコミュニティ</li>
          <p>コミュニティメンバーとして、建設的でポジティブなコミュニケーションを奨励します。</p>
          <li className="mb-2">フィードバック</li>
          <p>コンテンツの報告、不適切な行動の報告、コンテンツの品質向上に対するフィードバックは歓迎します。</p>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-4">
          ...
          <p>アカウントのセキュリティを確保し、他人にアクセス権を与えないように注意してください。</p>
        </ul>
      </section>

      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4">コミュニティガイドラインの違反</h2>
        <ul className="list-disc pl-4">
          <li className="mb-2">違反行為</li>
          <p>コミュニティガイドラインに違反する行為は厳禁であり、違反行為を報告することでサイトの安全性を維持しましょう。</p>
          <li className="mb-2">制裁</li>
          <p>コミュニティガイドラインに違反した場合、適切な制裁が課せられる可能性があります。制裁は違反の種類に応じて変動します。</p>
        </ul>
      </section>

      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4">変更と更新</h2>
        <p>当ポリシーは変更される場合があり、最新の情報は常にウェブサイト上で提供されます。定期的に確認してください。</p>
      </section>

      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4">お問い合わせ</h2>
        <p>ポリシーに関する質問や懸念事項がある場合、お問い合わせフォームを通じてご連絡ください。</p>
      </section>
